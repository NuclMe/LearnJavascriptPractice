...
// filter - ищет елемент по определенным парметрам  . Вернет новый массив  с елементов результатте своего выполнения. Если не найдет елемент, то вернет пустой массив
// синтаксис
