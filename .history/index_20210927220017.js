...
// sort - сортирует елементы приводя их к строке и сравнивая эти строки в порядке следования символов unicode.
//  сравнивает в лексикографическом порядке( Это сравнение "как в словаре" или "как в телефонном справочнике" - по алфавиту. Если первые буквы совпали, сравниваются вторые, если вторые совпали - третьи, и так далее.)
