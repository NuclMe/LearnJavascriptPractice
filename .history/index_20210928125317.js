...
// split,join разделяет по определенному парметру строку и преобразует ее в массив. Можно еще поставить 2 аргумент - количество символов которые максимум надо перебрать
