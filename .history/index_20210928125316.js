...
// split,join разделяет по определенному парметру строку и преобразует ее в массив. Можно ещн поставить 2 аргумент - количество символов которые максимум надо перебрать
