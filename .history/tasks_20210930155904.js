...
//   usersMapped.push(item);
// }

// let usersMapped = users.map((item) => item.fullname);
// // debugger;
// let elem = {};
// elem.fullname = fullname;
// usersMapped.push({ elem: elem });

let usersMapped = users.map((item) => item.surname + " " + item.name, this.concat({surname: th}));
// console.log(users + "hello"  );
// console.log(usersMapped);

console.log(users.concat({ surname: usersMapped }));
