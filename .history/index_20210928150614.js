...
// filter - ищет елемент по определенным парметрам  . Вернет новый массив  с елементами или елементом который true(в результатте своего выполнения. Если не найдет елемент, то вернет пустой массив
// синтаксис
