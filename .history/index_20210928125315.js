...
// split,join разделяет по определенному парметру строку и преобразует ее в массив. Можно щн поставить 2 аргумент - количество символов которые максимум надо перебрать
