...
// filter - ищет елемент по определенным парметрам  . Вернет новый массив  с елементомв результатте своего выполнения. Если не найдет елемент, то вернет пустой массив
// синтаксис
