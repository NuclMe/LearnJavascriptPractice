...
// reduce - вычесление единого значения массива. На каждой итерации запоминает значение и просто на следующей его плюсует
...
let s = arr4.reduce((sum, current) => sum + current, 0);
console.log(sum);
