...
// find - находит елемент с определенным условием. Если найдет искомый елемент, если нет - undefined
...
// filter - ищет елемент по определенным парметрам вернет true если елемент найден
